...
<body id="page-top">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="regAbogado.jsp">Registrar Empleado</a>
            <a class="collapse-item" href="../AbogadoControl?accion=listar">Listar Empleados</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Pages Collapse Menu -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="card shadow mb-4">
          ...
          <jsp:useBean id="pD" class="Dao.AbogadoDao" scope="request"></jsp:useBean>
  ...
  <div class="card border-primary mb-3" style="max-width: 18rem;">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Identificacion: <c:out value="${p.persona.getCedula()}"/></p>
      <p class="card-text">Correo: <c:out value="${p.persona.getCorreo()}" /></p>
      <p class="card-text">Especialidad: <c:out value="${p.especializacion}"/></p>
      <p class="card-text">Estado: <c:out value="${p.estado}"/></p><br>
      <form action="../AbogadoControl" method="get">
            <input type="hidden" name="id" value="${p.persona.getCedula()}">
